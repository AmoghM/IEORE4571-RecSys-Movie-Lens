...
def create_annoy_index(pickle_path,write_annoy_path,dim=6017):
    st = time.time()
...
def load_annoy(read_annoy_path, dim=6017):
    print(read_annoy_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-dim", help="dimension", default=6017,type=int)
